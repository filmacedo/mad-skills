...
Run after an edit. Mark every applicable check pass or fail. Fix each failure and run the evaluation again.

For Detect mode, run only **Provenance and authority**, **Anti-overfitting**, and **Detect output**.

## Provenance and authority

1. Was provenance established as AI-drafted, human-drafted, or mixed when it affects enforcement?
2. Was an available writer or brand voice profile loaded?
3. On human-drafted text, did the voice profile and voice preservation take precedence over generic pattern bans?

## Voice preservation

4. Does the edit preserve the writer's point without adding claims, examples, statistics, quotes, or opinions?
5. Does it preserve vocabulary, cadence, bluntness, humor, hedges, digressions, and level of polish?
6. Were strong human sentences left alone?
7. Was cutting proportional to actual slop?
8. Were typos and grammar errors corrected?

## Contested patterns

9. On AI-drafted text, were generic negative reframes, mic-drop endings, and performative fragment stacks removed?
10. On human-drafted text, were those patterns treated as density and intent checks rather than absolute bans?
11. Does each surviving negative reframe correct a real reader belief rather than a straw man?
12. Does each surviving aphorism add a thought rather than recap the piece?
13. Does each surviving fragment carry content or improve rhythm?

## Pattern sweep

14. Are empty participle clauses and padding gone?
15. Is weasel attribution sourced, cut, or flagged for the writer?
16. Is importance puffery replaced by the underlying fact?
17. Are inflated copulative phrases and forced synonym cycling gone?
18. Are throat-clearing, faux-insight, dramatic-reveal, and rhetorical setups gone?
19. Are false ranges and unnecessary meta-commentary gone?
