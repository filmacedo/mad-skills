...
The weekly digest is a read-only delivery view over Inbox Assistant classification and persona policy. It never replaces the daily cleanup checkpoint and never mutates Gmail.
